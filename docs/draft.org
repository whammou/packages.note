...
- #+NAME: reverse ssh representation
  #+BEGIN_SRC plain
                                                                      +-------------------+
                                                                      |  Local Machine    |
                                                                      | (Your Computer)   |
    ...
    Any SSH Client                                                   | +---------------+ |
          ...
          |    (e.g., ssh user@whamlab.sytes.net -p 2200)                     |    local machine forwards the
          v                                                                   |    connection to its own
  +---------------------------+                                                |    localhost:22.
  |      Remote Server        |                                                |
  |   (whamlab.sytes.net)     |      2. SSH Tunnel established by your command |
  |                           | <--------------------------------------------> |
  | +-----------------------+ |                                                |
