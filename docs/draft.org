...
** OUTL Qutebrowser Scripting :QUTEBROWSER:
:PROPERTIES:
...
** EXPL Modify Pandoc Parser Behaviour :PANDOC:
:PROPERTIES:
...
** OUTL Managing Dotfiles with Chezmoi :CHEZMOI:
DEADLINE: <2026-02-05 Thu>
:PROPERTIES:
...
#+NAME:~/.config/chezmoi/chezmoi.toml
#+BEGIN_SRC toml
[data]
  email = "me@home.org"
#+END_SRC
...
#+NAME:~/.local/share/chezmoi/dot_gitconfig.tmpl
#+BEGIN_SRC toml
[user]
  email = {{.email | quote}}
#+END_SRC
...
#+NAME:~/.local/share/chezmoi/.chezmoiignore
#+BEGIN_SRC gitignore
README.md
