...
#+FILETAGS: :topPackages:typDoc:subProject:subQutebrowser:
...
* DONE [#A] Rebind set-mark function
...
* PRTL [#A] Qutebrowser with Qtile [100%] :subQtile:
...
* DONE [#A] Qutebrowser modular configs
...
* PEND [#A] Change highlight colors using patch
