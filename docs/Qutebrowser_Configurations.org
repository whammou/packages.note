...
* PRTL Qutebrowser Configurations [77%] :typDoc:meta:PACKAGES:subQutebrowser:
...
** PRTL Qutebrowser with Qtile [100%] :subQtile:
...
** PEND Change highlight colors using patch
